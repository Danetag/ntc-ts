...
var ntcTs = (() => {
  ...
  __export(src_exports, {
    ...
    NOT_A_COLOR: () => NOT_A_COLOR,
    ORIGINAL_COLORS: () => ORIGINAL_COLORS,
    cachedColors: () => cachedColors,
    colors: () => colors,
    flushCachedColors: () => flushCachedColors,
  ...
  function isPopulatedColor(color) {
    return color.length >= 8 && color.slice(2, 8).every((value) => typeof value === "number" && Number.isFinite(value));
  }
  ...
  function getColorName(color) {
    ...
    for (let i = 0; i < colors.length; i++) {
      const currentColor2 = colors[i];
      const currentHexColor2 = `#${currentColor2[0]}`;
      const currentNameColor2 = String(currentColor2[1]);
      const populatedColor = populateColor(currentColor2);
      if (populatedColor !== currentColor2) colors[i] = populatedColor;
      if (color === currentHexColor2) {
        cachedColors[color] = formatColor(currentHexColor2, currentNameColor2, true);
        return cachedColors[color];
      }
...
//# sourceMappingURL=ntc-ts.umd.js.map