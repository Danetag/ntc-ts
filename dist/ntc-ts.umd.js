var ntcTs = (function (exports) {
    'use strict';

    exports.cachedColors = {};
    exports.colors = [['000000', 'Black']];
    const NOT_A_COLOR = 'not-a-color';
    ...
    function initColors(_colors) {
        exports.colors = clonePalette(_colors);
        flushCachedColors();
    }
    ...
    function getColorName(color) {
        ...
        for (let i = 0; i < exports.colors.length; i++) {
            const currentColor = exports.colors[i];
            ...
            if (populatedColor !== currentColor)
                exports.colors[i] = populatedColor;
            // Exact match
    ...
    exports.MINIMAL_COLORS = MINIMAL_COLORS;
    exports.NOT_A_COLOR = NOT_A_COLOR;
    exports.ORIGINAL_COLORS = ORIGINAL_COLORS;
    exports.createColorMatcher = createColorMatcher;
